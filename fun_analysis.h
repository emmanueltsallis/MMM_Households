...
EQUATION("IDLE")//Idle Capacity
RESULT(VS(country, "Country_Idle_Capacity"))

EQUATION("EMP")//Total Employment
RESULT(VS(country, "Country_Total_Employment"))
...
v[1] = SUM("Household_Effective_Real_Domestic_Consumption");
v[2] = SUM("Household_Effective_Real_Imported_Consumption");
RESULT(v[1] + v[2])
...
EQUATION("DEBT_RT_CL")//Average Debt Rate of all households
RESULT(WHTAVE("Household_Debt_Rate","Household_Nominal_Disposable_Income"))
...
EQUATION("IDLE_C")//Idle Capacity Rate of Consumption good sector
RESULT(VS(consumption, "Sector_Idle_Capacity"))

EQUATION("IDLE_K")//Idle Capacity Rate of Capital good sector
RESULT(VS(capital, "Sector_Idle_Capacity"))

EQUATION("IDLE_I")//Idle Capacity Rate of Intermediate good sector
