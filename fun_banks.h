...
/*
Total demand for loans, firms and households
*/
	v[10]=V("bank_id");
	...
	// Read global household loan demand
	v[4]=V("Country_Total_Household_Demand_Loans"); 

	v[6]=V("Bank_Market_Share");
	v[7]=v[0]+v[6]*v[4]; // Total Demand = Firm Demand + BankShare * Global Household Demand
...
/*
Total Stock of short term loans, firms and households portion
*/
	...
	// Read global household loan stock
	// NOTE: Assumes this global variable correctly represents short-term if necessary
	v[4]=V("Country_Total_Household_Stock_Loans"); 

	v[6]=V("Bank_Market_Share");
	v[7]=v[0]+v[6]*v[4]; // Total Stock = Firm Stock + BankShare * Global Household Stock
...
/*
Total Stock of deposits, firms and households portion
*/
	...
	// Read global household deposit stock
	v[4]=V("Country_Total_Household_Stock_Deposits");
...
/*
Bank Interest Payment (paid out on deposits) to firms and households portion
*/
v[10]=V("bank_id");
	...
	// Read global deposit returns paid to households
	v[4]=V("Country_Total_Household_Deposits_Return");

	v[6]=V("Bank_Market_Share");
	v[7]=v[0]+v[6]*v[4]; // Total Payment = Payment to Firms + BankShare * Global Household Payment
...
/*
Total interest payment received from firms and households portion
*/
	v[10]=V("bank_id");
	...
	// Read global interest payments received from households
	v[4]=V("Country_Total_Household_Interest_Payment");

	v[6]=V("Bank_Market_Share");
	v[7]=v[0]+v[6]*v[4]; // Total Received = Received from Firms + BankShare * Global Household Received
...
/*
Total debt principal payment received from firms and households portion
*/
	v[10]=V("bank_id");
	...
	// Read global debt payments received from households
